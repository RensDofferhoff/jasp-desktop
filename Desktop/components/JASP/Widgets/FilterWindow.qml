...
FocusScope
{
	property int	desiredMinimumHeight:	200//easyFilterConstructor.desiredMinimumHeight// : rFilterFields.desiredMinimumHeight

	function toggle()
	{
		filterContainer.opened = !filterContainer.opened
//		absorbModelRFilter()
			...
			FocusScope {
				...
				Item
				{
					...
					anchors
					{
						...
						rightMargin:	Math.min(0, filterRoot.width - minWidthCollector.minWidth)
					}
					...
					Item
					{
						anchors.fill:		parent
						anchors.margins:	1
						visible:			filterRoot.showEasyFilter


						FilterConstructor
						{
							id:				easyFilterConstructor
							onRCodeChanged: rCodeChanged(rScript)
							clip:			true
						...
						JaspControls.RectangularButton
						{
							...
							onClicked:	easyFilterConstructor.askIfChanged(function() { filterRoot.showEasyFilter = false } )
							width:		height
					...
					Item
					{
						...
						Item
						{
							...
							JaspControls.RectangularButton
							{
								...
								onClicked:		filterEditRectangle.askIfChanged(function (){ filterRoot.showEasyFilter = true })
							...
							JaspControls.RectangularButton
							{
								...
								height:		filterRoot.buttonsHeight
