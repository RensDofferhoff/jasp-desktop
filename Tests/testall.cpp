...
{
	// The excision, Cut 3: DatabaseInterface::singleton()->close()/closeInterfaces() died
	// with the class.
	delete _pkg;
	_pkg = nullptr;
}
...
// testFilterRevisionInvalidatedRoundTrip died with DatabaseInterface (the excision, Cut 3) —
